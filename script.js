...
function lapDiff(time1, time2) {
    ...
    lapMTPDiff = `${timeDiffHours > 9 ? timeDiffHours : "0" + timeDiffHours}:${timeDiffMinutes > 9 ? timeDiffMinutes : "0" + timeDiffMinutes
...
function checkLapReset() {
    if (!(swElem.innerHTML == "00:00:00")) {
        ...
        if (swLapBtn.classList.contains("can-click")) {
